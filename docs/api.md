...
Complete API reference for the CMX multi-format backend framework.
...
The main application class for creating an CMX server.
...
```javascript
import parseURL from 'cmx/utils/urlParser.js';
...
```javascript
import deepMerge from 'cmx/utils/deepMerge.js';
